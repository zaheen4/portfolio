    ...
    var handler = function () {
      ...
      if (theme === "system") {
        document.documentElement.setAttribute(
          "data-theme",
          media.matches ? "warm-dark" : "warm-light",
        );
      }
    };
  ...
  return (
    <div className="relative">
      ...
      {visible && (
        <>
          <div
            className={`fixed inset-0 z-40 transition-opacity duration-150 ${isOpen ? "opacity-100" : "opacity-0"}`}
            aria-hidden="true"
          />
          <div
            ref={dropdownRef}
          ...
          >
            ...
            <div
              className="theme-scroll p-3 pb-6"
              role="listbox"
              ...
              <div className="space-y-1">
                {lightThemes.map((theme, i) => (
                  <button
                    ...
                    aria-selected={selectedTheme === theme.id}
                    tabIndex={
                      activeIndex === i + darkThemes.length + 1 ? 0 : -1
                    }
                  >
                    <span
                      className="w-5 h-5 rounded-full flex-shrink-0 dot"
